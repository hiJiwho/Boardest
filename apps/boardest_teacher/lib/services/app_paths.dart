...
/// Boardest 교사용 앱 데이터 경로 (Windows AppX 샌드박스: %LOCALAPPDATA%\Packages\jiwho.boardest.teacher_nmkn64tehfz7a\LocalState).
class AppPaths {
  AppPaths._();

  static const String appName = 'jiwho.boardest.teacher';
  static const String packageFamilyName = 'jiwho.boardest.teacher_nmkn64tehfz7a';
