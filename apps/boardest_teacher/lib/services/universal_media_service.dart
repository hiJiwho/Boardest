...
import 'youtube_embed_service.dart';
...
class UniversalMediaService {
  ...
  static Future<File?> downloadMediaToMp4(
    ...
    try {
      final mediaDir = Directory(p.join(AppPaths.bstSaveRootSync, 'MEDIA'));
      ...
      if (type == MediaType.directMp4) {
        ...
        final ytFile = await YouTubeEmbedService.downloadVideoDirectly(
          url,
          customSavePath: targetPath,
