...
class TimeSettings {
  ...
  factory TimeSettings.fromJson(Map<String, dynamic> json) {
    return TimeSettings(
      ...
      afternoonAssemblyAfterMinutes: json['afternoonAssemblyAfterMinutes'] as int? ?? 10,
      afternoonAssemblyDuration: json['afternoonAssemblyDuration'] as int? ?? 20,
...
class AppSettings {
  ...
  factory AppSettings.fromJson(Map<String, dynamic> json) {
    ...
    return AppSettings(
      ...
      isHomeroom: json['isHomeroom'] == true || json['isHomeroom'] == 'true' || json['isHomeroom'] == null,
      timeSettings: json['timeSettings'] != null
          ? TimeSettings.fromJson(json['timeSettings'] as Map<String, dynamic>)
          : TimeSettings(),
      textbookImages: (json['textbookImages'] as Map?)?.map(
      ...
      pinnedDday: json['pinnedDday'] != null
          ...
          : null,
      scaleFactor: (json['scaleFactor'] as num?)?.toDouble() ?? 1.2,
      selectedSystemApps: sysApps,
      launcherSlots: loadedSlots,
      autoSleepEnabled: json['autoSleepEnabled'] as bool? ?? false,
      cafeteriaNum: json['cafeteriaNum']?.toString() ?? '급식실1',
      mealCallClassOrder: json['mealCallClassOrder']?.toString() ?? 'asc',
      specialClassroomType: json['specialClassroomType'] as int? ?? (json['specialClassroomMode'] as bool? ?? false ? 3 : 0),
      selectedSubject: json['selectedSubject']?.toString() ?? '',
      connectionName: json['connectionName']?.toString() ?? 'My',
      classNickname: json['classNickname']?.toString() ?? '',
      selectedTeacher: json['selectedTeacher']?.toString() ?? '',
      selectedTeacherId: json['selectedTeacherId']?.toString() ?? (json['selectedTeacher']?.toString() ?? ''),
      selectedTeacherName: json['selectedTeacherName']?.toString() ?? '',
