...
class UsbSessionService {
  ...
  static const _tbpExts = {'.tbp', '.bsttbp', '.bstTBP', '.TBP'};
  static const _iwbExts = {'.iwb'};
  static const _hwpExts = {'.hwp'};
  static const _videoExts = {'.mp4', '.mkv', '.avi'};
  static final _allExts = {..._pptExts, ..._pdfExts, ..._tbpExts, ..._iwbExts, ..._hwpExts, ..._videoExts};
  ...
  Future<File> _getFile() async {
    if (kIsWeb || !Platform.isWindows) {
      ...
      if (!kIsWeb && !await targetDir.exists()) {
