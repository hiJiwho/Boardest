...
class WebsiteBoardView extends StatefulWidget {
  ...
  const WebsiteBoardView({super.key, required this.scaleFactor, this.initialUrl});
...
class _WebsiteBoardViewState extends State<WebsiteBoardView> {
  ...
  void initState() {
    ...
    _urlController = TextEditingController(
      text: widget.initialUrl?.isNotEmpty == true ? widget.initialUrl! : defaultSiteUrl,
    );
  ...
  Widget _buildWebViewLayer() {
    if (kIsWeb) {
      final url = _urlController.text.trim().isNotEmpty ? _urlController.text.trim() : defaultSiteUrl;
