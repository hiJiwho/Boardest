...
class _PluginStoreViewState extends State<PluginStoreView> {
  ...
  void _fetchStoreRegistry() async {
    ...
    const url =
        'https://raw.githubusercontent.com/hiJiwho/bst-store/main/plugins.json';
    try {
      ...
      if (res.statusCode == 200) {
        ...
        setState(() {
          _storePlugins = data
              .map((x) => BstPluginMetadata.fromJson(x))
              .toList();
        });
      } else {
    ...
    setState(() {
      _storePlugins = [
        BstPluginMetadata(
          ...
          iconEmoji: '⏱️',
          downloadUrl:
              'https://raw.githubusercontent.com/hiJiwho/bst-store/main/bundles/stopwatch.bstplus',
          role: 'both',
        ),
        BstPluginMetadata(
          ...
          iconEmoji: '🎡',
          downloadUrl:
              'https://raw.githubusercontent.com/hiJiwho/bst-store/main/bundles/drawgame.bstplus',
          role: 'teacher',
        ),
        BstPluginMetadata(
          ...
          iconEmoji: '🔊',
          downloadUrl:
              'https://raw.githubusercontent.com/hiJiwho/bst-store/main/bundles/noisewatcher.bstplus',
          role: 'student',
        ),
      ];
    });
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: active ? const Color(0xFF00F5D4) : Colors.white10,
          ),
        ),
        child: Text(
          label,
    ...
    if (isInstalled) {
      return ElevatedButton(
        style: ElevatedButton.styleFrom(
          backgroundColor: const Color(0xFF00F5D4).withOpacity(0.2),
        ),
        onPressed: () {
