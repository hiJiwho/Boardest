...
class VideoCollectionBoardView extends StatefulWidget {
  ...
  @override
  State<VideoCollectionBoardView> createState() =>
      _VideoCollectionBoardViewState();
}
...
class _VideoCollectionBoardViewState extends State<VideoCollectionBoardView> {
  ...
  Future<void> _downloadFromUrl() async {
    ...
    if (file != null && file.existsSync()) {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('영상 다운로드 실패: $_downloadStatus')));
    }
  }
  ...
  void _openInVideoBoard(VideoItem item) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => YoutubeBoardView(
          initialUrl: item.path,
