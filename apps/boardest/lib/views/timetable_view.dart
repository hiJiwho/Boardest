...
class _TimetableViewState extends State<TimetableView>
  ...
  void _openSettings() async {
    final result = await Navigator.of(
      context,
    ).push(MaterialPageRoute(builder: (context) => const SetupWizardView()));
  ...
  List<Lesson> _getFilteredLessons() {
    ...
    if (_appSettings.specialClassroomMode) {
      final teacherName = _appSettings.selectedTeacherId
          .replaceAll('*', '')
          .trim();
      ...
      return _timetableResult!.lessons
          .where((lesson) {
            return lesson.grade == _selectedGrade &&
                lesson.classNum == _selectedClass;
          })
          .map((l) {
            return Lesson(
              grade: l.grade,
  ...
  Widget _buildCalendarView(double scale) {
    ...
    final startWeekday =
        firstDayOfMonth.weekday % 7; // 0 for Sunday, 6 for Saturday
                ...
                children: [
                  ...
                  Row(
                    children: weekDays.asMap().entries.map((entry) {
                      ...
                      if (idx == 0)
                        textColor = const Color(0xFFEF4565); // Sunday
                      if (idx == 6)
                        textColor = const Color(0xFF00F5D4); // Saturday
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isCurrentMonthDay =
                            cellDayNumber > 0 && cellDayNumber <= daysInMonth;
            ...
            children: List.generate(5, (index) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, idx) {
                  ...
                  final imgPath = _appSettings.getTextbookPath(
                    lesson.subject,
                    grade: lesson.grade,
                  );
                  final hasImage =
