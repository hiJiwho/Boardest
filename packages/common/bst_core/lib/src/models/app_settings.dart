  ...
  factory AppSettings.fromJson(Map<String, dynamic> json) {
    ...
    return AppSettings(
      selectedSchool: json['selectedSchool'] != null
          ...
          : null,
      schoolId: json['schoolId'] as String? ?? 'ydm',
      ...
      selectedTeacherId: json['selectedTeacherId'] as String? ?? (json['selectedTeacher'] as String? ?? ''),
      selectedTeacherName: json['selectedTeacherName'] as String? ?? '',
      themeMode: json['themeMode'] as String? ?? 'system',
      themeColor: json['themeColor'] as String? ?? 'system',
